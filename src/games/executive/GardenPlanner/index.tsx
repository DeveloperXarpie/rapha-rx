...
export default function GardenPlanner({ levelConfig, onLevelComplete }: Props) {
  ...
  function handleComplete() {
    onLevelComplete({
      ...
      completed: true,
      metrics: {
        firstPlacementCorrect: 0,
        totalPlants: levelConfig.params.plantCount as number,
        weatherAdaptationCorrect: null,
      },
    });
  }
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 gap-8 text-center">
      ...
      <h3 className="text-h1 font-bold text-body-text">Garden Planner</h3>
