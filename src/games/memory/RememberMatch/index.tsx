...
export default function RememberMatch({ levelConfig, onLevelComplete }: Props) {
  ...
  function handleComplete() {
    onLevelComplete({
      ...
      completed: true,
      metrics: { flipAttempts: 0, quizCorrect: 0, quizTotal: levelConfig.params.quizQuestions as number },
    });
  }
  ...
  return (
    <div className="flex-1 flex flex-col items-center justify-center p-8 gap-8 text-center">
      ...
      <h3 className="text-h1 font-bold text-body-text">Remember &amp; Match</h3>
