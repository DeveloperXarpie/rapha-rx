 ...
 * palette instead.
 *
 * The plank's three sliced pieces used to be here too. The Sep-17 review replaced the
 * signboard with the shared blue instruction panel, so nothing references them any more.
 * `scripts/slice_spot_focus_assets.py` still cuts them into `public/spot-assets/`.
 */
